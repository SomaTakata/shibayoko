...
const WorkPage = () => (
  <section className="flex z-10 min-h-screen  w-full overflow-hidden   bg-white flex-col gap-6  px-5 py-14 pb-20  sm:gap-12 sm:px-10 md:px-14 md:py-32 lg:gap-16 lg:border-t-[3px]">
