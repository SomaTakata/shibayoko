  ...
  return (
    <div className="mx-auto max-w-sm rounded-xl border-2 border-black bg-white p-10">
      ...
      <div className="text-center">
        <h2 className="mt-3 font-roboto text-4xl font-bold tracking-widest text-white text-stroke-1">PROFILE</h2>
        <p className="mt-3 font-roboto text-sm font-bold text-black">Web Engineer</p>
        <h1 className="mt-1 font-roboto text-3xl font-extrabold">SOMA TAKATA</h1>
